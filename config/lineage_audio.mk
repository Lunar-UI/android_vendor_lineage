...
ALARM_PATH := vendor/lunar/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/lunar/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/lunar/prebuilt/common/media/audio/ringtones
